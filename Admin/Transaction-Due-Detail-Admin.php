                                ...
                                <div class="row justify-content-around">
                                    <div style="background-color: white; margin-top: 2%; padding:3%" class="col-10">
                                        <table class="table table-stripped">
                                            ...
                                            <?php
                                            $result = mysqli_query($conn, "SELECT * FROM `dues` INNER JOIN due_user_flat USING (dueId) INNER JOIN users USING (userId) WHERE dueId = '$dueId' AND is_paid = 0");
                            ...
                            <div class="card-body">
                                <div class="row justify-content-around">
                                    ...
                                    <table class="table table-stripped">
                                            ...
                                            <?php
                                            $result = mysqli_query($conn, "SELECT * FROM `dues` INNER JOIN due_user_flat USING (dueId) INNER JOIN users USING (userId) WHERE dueId = '$dueId' AND is_paid = 1");
